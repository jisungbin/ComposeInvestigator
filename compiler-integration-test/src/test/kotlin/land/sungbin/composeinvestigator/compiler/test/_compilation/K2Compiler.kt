...
class K2CompilerFacade(environment: KotlinCoreEnvironment) : KotlinCompilerFacade(environment) {
  ...
  private fun createSourceSession(
    ...
    return FirJvmSessionFactory.createModuleBasedSession(
      ...
      javaSourcesScope = PsiBasedProjectFileSearchScope(
      ...
      jvmTarget = configuration.get(JVMConfigurationKeys.JVM_TARGET)
        ?: error("JVM_TARGET is not specified in compiler configuration"),
  ...
  override fun compile(
    ...
    codegenFactory.generateModuleInFrontendIRMode(
      generationState,
      irModuleFragment,
      frontendResult.firResult.components.symbolTable,
