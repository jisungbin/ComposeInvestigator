...
import land.sungbin.composeinvestigator.compiler.base.AndroidxComposeRuntime
...
internal abstract class AbstractComposableCallstackTrackLower(
  ...
  abstract fun transformComposableCall(parent: FqName, expression: IrCall): IrExpression
