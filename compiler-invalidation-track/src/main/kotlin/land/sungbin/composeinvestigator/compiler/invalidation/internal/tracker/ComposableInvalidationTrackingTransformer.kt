...
import land.sungbin.composeinvestigator.compiler.base.HandledMap
import land.sungbin.composeinvestigator.compiler.base.IrStatementContainerImpl
import land.sungbin.composeinvestigator.compiler.base.MUTABLE_LIST_ADD_FQN
import land.sungbin.composeinvestigator.compiler.base.MUTABLE_LIST_OF_FQN
import land.sungbin.composeinvestigator.compiler.base.REGISTER_STATE_OBJECT_TRACKING_FQN
...
internal class ComposableInvalidationTrackingTransformer(
  ...
  override fun transformStateInitializer(composable: IrSimpleFunction, stateName: Name, initializer: IrExpression): IrExpression {
    ...
    return IrCallImpl.fromSymbolOwner(
      ...
      register.origin = land.sungbin.composeinvestigator.compiler.invalidation.origin.StateChangeTrackerOrigin
    }.apply {
